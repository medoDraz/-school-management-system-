    ...
    <div style="display: none" class="row setup-content" id="step-1">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.Email')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.Password')}}</label>
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.Name_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.Name_Father_en')}}</label>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <label for="title">{{trans('site.Parent_trans.Job_Father')}}</label>
                    ...
                    <div class="col-md-3">
                        <label for="title">{{trans('site.Parent_trans.Job_Father_en')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.National_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.Passport_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('site.Parent_trans.Phone_Father')}}</label>
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('site.Parent_trans.Address_Father')}}</label>
                ...
                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="firstStepSubmit"
                        type="button">{{trans('site.Parent_trans.Next')}}
                </button>
